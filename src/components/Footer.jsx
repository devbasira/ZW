...
export const Footer = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    setIsLoading(true);
    try {
      const addContact = await addDoc(collection(db, "formSubmission"), {
        name,
        email,
        message,
        time: new Date(),
  ...
  return (
    <div
      ref={ref}
      className="w-screen z-20 bg-[#292B31] flex pt-[150px] pb-[100px] md:px-[100px] flex-col justify-center items-center"
    >
        ...
        <div className="flex flex-col w-full gap-[40px]">
          <div className="w-full flex flex-col md:flex-row gap-[40px] md:gap-[200px]">
            <div className="flex items-center justify-center md:justify-start gap-4 text-sm">
              <a className="hover:underline transition duration-200 text-white text-[22px] leading-8">
