...
function Experience() {
    return (
        ...
        >
            <div className="lg:w-[1200px] w-full flex flex-col items-center lg:items-start justify-between pt-[80px] lg:pt-[235px] pb-[80px] lg:pb-[235px] px-4 lg:px-0">
                ...
                <div className="w-full lg:w-[672px] flex flex-col gap-[30px] lg:gap-[48px]">
                    ...
                    <div className="gap-[20px] lg:gap-[30px] flex flex-col mt-[10px]">
                        <p className="text-[18px] lg:text-[24px]">
                            ...
                            <span className="text-[#0A3C93] underline cursor-pointer">
